...
import { CARD_ANIMATION, FADE_IN_UP } from '../../../utils/animations';
import { MaterialModule } from '../../../material.module';
import { SteamUserProfile, SteamLibraryStats, SteamGameInfo } from '../../../models/game.model';
...
export class SteamStatsComponent implements OnInit, OnDestroy {
  ...
  private checkIfMobile(): void {
    ...
    // Consider it mobile if it meets any of these criteria
    this.isMobile = isMobileWidth || (isMobileDevice && isTouchDevice);
  }
